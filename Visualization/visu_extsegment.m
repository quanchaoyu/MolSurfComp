function visu_extsegment
DataGlob;

division=20; % each segment is divided to 100 
n=ncrasegment(:,1:3);
...
for i=1:nsegment
    ...
    P=real(P);
    if ext_segment(i)==1
        plot3(P(1:division,1),P(1:division,2),P(1:division,3),'Color',[0.9100    0.800    0.1700]);
        plot3(P([1,division],1),P([1,division],2),P([1,division],3),'b.','MarkerSize',8);
    else
        %plot3(P(:,1),P(:,2),P(:,3),'r-','LineWidth',1)
        %plot3(P([1,division],1),P([1,division],2),P([1,division],3),'r.','MarkerSize',12);
    end
